// PLMSidebar.tsx - nav panel for the PLM Manager role
...
const PLMSidebar: React.FC<PLMSidebarProps> = ({
  isCollapsed,
    ...
    <>
      ...
      >
        ...
        <div className="h-16 flex items-center justify-between px-4 border-b border-slate-200 dark:border-slate-700 shrink-0">
          ...
          >
            <BrandLogo role="branch-admin" branch="Manila" roleLabel="PLM" />
          </div>
