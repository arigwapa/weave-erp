  ...
  return (
    <>
      ...
      >
        ...
        {/* scrollable nav */}
        <nav className="flex-1 min-h-0 overflow-y-auto overscroll-contain p-4 space-y-2 custom-scrollbar dark:text-slate-300 border-r border-slate-200 dark:border-slate-700">
