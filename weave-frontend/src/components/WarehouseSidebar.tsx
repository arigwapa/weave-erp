// WarehouseSidebar.tsx - nav panel for the Warehouse Manager role
...
const menuGroups = [
  {
    ...
    items: [
      ...
      { icon: ClipboardList, label: "My Tasks", path: "/warehouse/tasks" },
    ],
  },
  {
    label: "Operations",
    items: [
      ...
      { icon: Search, label: "Search / Records", path: "/warehouse/records" },
    ],
  },
  {
    label: "Inventory",
    items: [{ icon: Package, label: "Inventory Activation", path: "/warehouse/inventory" }],
  },
  {
    label: "Approvals",
    items: [
      { icon: PackageCheck, label: "Dispatch / Transfer", path: "/warehouse/dispatch" },
      { icon: Settings, label: "Profile & Settings", path: "/warehouse/profile-settings" },
    ],
  },
  {
    label: "Reports",
