// DetailsModal.tsx - modal showing a grid of labeled fields + optional body content
...
const DetailsModal: React.FC<DetailsModalProps> = ({
  ...
  return createPortal(
    <div className={`fixed inset-0 ${zIndexClass} flex items-center justify-center bg-slate-900/40 backdrop-blur-sm animate-in fade-in duration-200 p-4`}>
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-3xl max-h-[90vh] flex flex-col overflow-hidden animate-in slide-in-from-bottom-4 duration-300">
        ...
        <div className="p-6 md:p-8 space-y-6 overflow-y-auto">
          ...
          {children && <div className="h-px bg-slate-100 w-full" />}
